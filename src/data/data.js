...
export const restaurants = [
  ...
  // 二餐----------------------------------------------------------------------
  {
    ...
    category: '第二餐廳',
    hours: [{ open: '10:30', close: '13:30' }, { open: '16:30', close: '19:30' }],
    days: [1, 2, 3, 4, 5],
    menu: [
      { id: 1, name: '雞腿飯', price: 80 },
    ],
    payment: ['cash'],
  },

  {
    ...
    englishName: 'Taizu',
    category: '第二餐廳',
    hours: [{ open: '10:30', close: '14:00' }, { open: '16:30', close: '20:00' }],
    days: [0, 1, 2, 3, 4, 5, 6],
    menu: [
      { id: 1, name: '魷魚羹麵', price: 65 },
      { id: 2, name: '魷魚羹米粉', price: 65 },
      { id: 3, name: '魷魚羹冬粉', price: 65 },
      { id: 4, name: '肉羹麵', price: 60 },
      { id: 5, name: '綜合羹', price: 75 },
    ],
...

  {
    ...
    days: [0, 1, 2, 3, 4, 5, 6],
    menu: [
      { id: 1, name: '豬排漢堡', price: 55 },
      { id: 2, name: '雞腿堡', price: 65 },
      { id: 3, name: '總匯三明治', price: 60 },
      { id: 4, name: '蛋餅', price: 35 },
      { id: 5, name: '鮪魚蛋餅', price: 45 },
      { id: 6, name: '奶茶', price: 30 },
    ],
...

  {
    ...
    category: '第二餐廳',
    hours: [{ open: '11:00', close: '13:30' }, { open: '16:30', close: '19:30' }],
    days: [0, 1, 2, 3, 4, 5],
    menu: [
  ...
  },
  {
    ...
    category: '第二餐廳',
    hours: [{ open: '10:30', close: '14:00' }, { open: '17:00', close: '20:00' }],
    days: [1, 2, 3, 4, 5],
    menu: [
  ...
  },
  {
    ...
    category: '第二餐廳',
    hours: [{ open: '11:00', close: '13:30' }, { open: '16:30', close: '19:00' }],
    days: [0, 1, 2, 3, 4, 5],
    menu: [
  ...
  },
  {
    ...
    category: '第二餐廳',
    hours: [{ open: '10:30', close: '14:00' }, { open: '16:30', close: '19:30' }],
    days: [1, 2, 3, 4, 5],
    menu: [
